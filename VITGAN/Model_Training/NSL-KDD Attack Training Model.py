...
input_dim = 41  # Input dimension  (features)
...
generator_benign = Generator(input_dim, 41).to(device)
...
if __name__ == '__main__':
    ...
    # Save the models
    torch.save(generator_attack.state_dict(), "generator_KDD_attack.pth")
    torch.save(discriminator_attack.state_dict(), "discriminator_KDD_attack.pth")
    torch.save(generator_benign.state_dict(), "generator_KDD_benign.pth")
    torch.save(discriminator_benign.state_dict(), "discriminator_KDD_benign.pth")
