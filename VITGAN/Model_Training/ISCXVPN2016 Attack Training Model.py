...
class Generator(nn.Module):
    def __init__(self, input_dim, output_dim):
        ...
        self.fc = nn.Sequential(
            nn.Linear(input_dim, 128),    # Input size is 23 features
            nn.ReLU(),
...
input_dim = 23  # Input feature dimension
...
generator_attack = Generator(input_dim, 23).to(device)
generator_benign = Generator(input_dim, 23).to(device)
...
if __name__ == '__main__':
    ...
    # Shuffle the normal benign data
    ...
    # save model
    torch.save(generator_attack.state_dict(), "generator_VPN16_attack.pth")
    torch.save(discriminator_attack.state_dict(), "discriminator_VPN16_attack.pth")
    torch.save(generator_benign.state_dict(), "generator_VPN16_benign.pth")
    torch.save(discriminator_benign.state_dict(), "discriminator_VPN16_benign.pth")