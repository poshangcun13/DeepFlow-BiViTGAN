...
def load_data():
    ...
    filename = 'Cross Platform data.csv'
...
if __name__ == '__main__':
    ...
    # Save the models
    torch.save(generator_attack.state_dict(), "generator_cplt_attack.pth")
    torch.save(discriminator_attack.state_dict(), "discriminator_cplt_attack.pth")
    torch.save(generator_benign.state_dict(), "generator_cplt_benign.pth")
    torch.save(discriminator_benign.state_dict(), "discriminator_cplt_benign.pth")