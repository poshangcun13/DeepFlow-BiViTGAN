...
if __name__ == '__main__':
    ...
    discriminator_attack.load_state_dict(torch.load('discriminator_VPN16_attack.pth'))
    discriminator_benign.load_state_dict(torch.load('discriminator_VPN16_benign.pth'))
    discriminator_attack.eval()  # Set model to evaluation mode
    discriminator_benign.eval()  # Set model to evaluation mode

    # Iterate through test data and calculate metrics
    n = 0
    y_true = []
    y_pred = []
