...
if __name__ == '__main__':
    ...
    discriminator_attack.load_state_dict(torch.load('discriminator_KDD_attack.pth'))
    discriminator_benign.load_state_dict(torch.load('discriminator_KDD_benign.pth'))
