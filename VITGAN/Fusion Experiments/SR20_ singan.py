...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        for i, attack_data in tqdm(enumerate(feature22), total=len(feature22),
            ...
            if i % 100 == 0:  # 每100步输出一次损失
                print(f"Step {i}, Loss G Afake: {loss_G_attack.item():.4f}, Loss D Afake: {loss_D_attack.item():.4f}")
...
# save model
torch.save(discriminator_attack.state_dict(), 'singan_SR20.pth')
