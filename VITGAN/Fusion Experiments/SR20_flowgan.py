...
if __name__ == '__main__':
    ...
    # Display training progress bar
        for i, attack_data in tqdm(enumerate(feature22), total=len(feature22), desc=f"Training attack Epoch {epoch+1}/{num_epochs}"):
...
# Save the models
torch.save(discriminator_attack.state_dict(), "SR20_flowgan_attack.pth")
torch.save(discriminator_benign.state_dict(), "SR20_flowgan_benign.pth")
